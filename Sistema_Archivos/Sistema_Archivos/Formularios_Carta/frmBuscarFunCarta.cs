...
{
    public partial class frmBuscarFunCarta : Form
    {
        public frmBuscarFunCarta()
        {
            InitializeComponent();
        }
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoCartaDAL().ConsultarFun(txtFun.Text);
        ...
        private void BtnVerTodo_Click(object sender, EventArgs e)
        {
            try
            {
                dgvBuscarFun.DataSource = null;
                lblCantidad.Text = "0";
                DataTable consulta = new ArchivoCartaDAL().VerTodosFun();
                dgvBuscarFun.DataSource = consulta;
                Formato_dgv();
                lblCantidad.Text = dgvBuscarFun.Rows.Count.ToString("N0");
            }
