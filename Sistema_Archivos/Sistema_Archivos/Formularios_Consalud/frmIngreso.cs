    ...
    public partial class frmIngreso : Form
    {
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoDAL().BuscarFUN(txtFun.Text);
        ...
        private void BtnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (string.IsNullOrWhiteSpace(txtTipoFun.Text))
                {
                    MessageBox.Show("Ingrese el tipo de FUN.", "CAMPO VACÍO", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                ...
                else
                {
                    ...
                    if (cmbMotivo.Text == "Habilitado")
                    {
                        ...
                        int ingresar = new ArchivoDAL().Ingreso(txtFun.Text, txtTipoFun.Text, txtRutAfiliado.Text, txtNombreEmpresa.Text, txtDireccionEmpresa.Text, txtComunaEmpresa.Text,
        ...
        private void CmbNotificador_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmbNotificador.Text != "Sin Notificador")
            {
                txtFechaCarga.Text = DateTime.Now.Date.ToShortDateString();
            }
            else
            {
                txtFechaCarga.Text = "";
