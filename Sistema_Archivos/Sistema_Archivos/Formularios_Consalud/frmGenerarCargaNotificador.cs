...
{
    public partial class frmGenerarCargaNotificador : Form
    {
        public frmGenerarCargaNotificador()
        {
            InitializeComponent();
        }
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Data.DataTable consulta = new ArchivoDAL().GenerarArchivoCarga(notificador, fecha);
        ...
        private void frmGenerarCargaNotificador_Load(object sender, EventArgs e)
        {
            try
            {
                Info_dgv();
