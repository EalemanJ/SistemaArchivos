...
namespace Sistema_Archivos
{
    public partial class frmSeleccionarSistema : Form
    {
        ...
        private void BtnCruzBlanca_Click(object sender, EventArgs e)
        {
            Sesion.Menu_salir = "";
            frmMenuPrincipalCruzBlanca mp = Application.OpenForms["frmMenuPrincipalCruzBlanca"] as frmMenuPrincipalCruzBlanca;
            if (mp != null)
            {
                mp.Focus();
                mp.Show();
            ...
            {
                frmMenuPrincipalCruzBlanca mp1 = new frmMenuPrincipalCruzBlanca();
                mp1.Show();
            }
            Hide();
        }
