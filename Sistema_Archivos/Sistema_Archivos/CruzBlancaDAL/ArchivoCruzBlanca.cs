...
{
    internal class ArchivoCruzBlanca
    {
        private Conexion conectar;

        public ArchivoCruzBlanca()
        {
        ...
        public DataTable VerAnterior(string rut, string fun)
        {
            ...
            sel.CommandText = @"SELECT TOP 1 sa_archivo_cruz_blanca_direccion_dg
                FROM sa_archivo_cruz_blanca
                WHERE sa_archivo_cruz_blanca_rut_afiliado = @rut AND sa_archivo_cruz_blanca_fun <> @fun
                ORDER BY sa_archivo_cruz_blanca DESC";
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "SELECT * FROM sa_empresa_inubicable_cruz_blanca WHERE sa_empresa_inubicable_cruz_blanca_rut = @rut";
            sel.Parameters.AddWithValue("@rut", rut);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        public int EliminarRechazado(string rut)
        {
            ...
            conectar.Abrir();
            del.CommandText = "DELETE FROM sa_empresa_inubicable_cruz_blanca WHERE sa_empresa_inubicable_cruz_blanca_rut = @rut";
        ...
        public int IngresaInubicable(string rut)
        {
            ...
            ins.CommandText = "INSERT INTO sa_empresa_inubicable_cruz_blanca VALUES (@rut)";
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select * from sa_archivo_Cruz_Blanca where sa_archivo_Cruz_Blanca_fun = @fun";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
            ...
            int notificador, int usuario)
        {
            ...
            " sa_archivo_Cruz_Blanca_direccion_empresa, sa_archivo_Cruz_Blanca_comuna_empresa, sa_motivo, sa_estado_rechazado_Cruz_Blanca, sa_archivo_Cruz_Blanca_direccion_dg, sa_archivo_Cruz_Blanca_fecha_ingreso, " +
            " sa_archivo_Cruz_Blanca_fecha_carga, sa_archivo_Cruz_Blanca_fecha_notificacion, sa_archivo_Cruz_Blanca_fecha_dg, sa_archivo_Cruz_Blanca_fecha_proceso, sa_archivo_Cruz_Blanca_fecha_rendicion, " +
            " sa_archivo_Cruz_Blanca_fecha_rechazo, sa_archivo_Cruz_Blanca_fecha_finiquito, sa_archivo_Cruz_Blanca_fecha_descarga, sa_notificador, sa_usuario) " +
        ...
        public DataTable GenerarArchivoRendicion(string fecha, int usuario, string tipo_rendicion)
        {
            ...
            sel.CommandText = @"
                ...
                WHERE a.sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha AND a.sa_usuario = @usuario AND sa_archivo_Cruz_Blanca_tipo_descarga = @tipo_rendicion 
                ORDER BY a.sa_archivo_Cruz_Blanca_orden_rendicion";
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.sa_archivo_Cruz_Blanca_tipo_fun, n.sa_notificador_nombre, a.sa_archivo_Cruz_Blanca_rut_afiliado, a.sa_archivo_Cruz_Blanca_nombre_empresa, " +
            " a.sa_archivo_Cruz_Blanca_direccion_empresa, a.sa_archivo_Cruz_Blanca_comuna_empresa, a.sa_archivo_Cruz_Blanca_fecha_ingreso, " +
            " a.sa_archivo_Cruz_Blanca_fecha_carga, a.sa_archivo_Cruz_Blanca_fecha_rendicion " +
            " from sa_archivo_Cruz_Blanca as a " +
            " inner join sa_notificador as n on a.sa_notificador = n.sa_notificador " +
            " where a.sa_archivo_Cruz_Blanca_fun = @fun";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        public int ActualizarFechaRendicion(string fecha_rendicion, string fun)
        {
            ...
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion where sa_archivo_Cruz_Blanca_fun= @fun";
        ...
        public int EliminarFun(int codigo)
        {
            ...
            SqlCommand del = conectar.Comando();
            conectar.Abrir();
            del.CommandText = "delete from sa_archivo_Cruz_Blanca where sa_archivo_Cruz_Blanca = @codigo";
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.sa_archivo_Cruz_Blanca, a.sa_archivo_Cruz_Blanca_fun, a.sa_archivo_Cruz_Blanca_tipo_fun, " +
            " n.sa_notificador_nombre, a.sa_archivo_Cruz_Blanca_rut_afiliado, " +
            " a.sa_archivo_Cruz_Blanca_nombre_empresa, a.sa_archivo_Cruz_Blanca_direccion_empresa, a.sa_archivo_Cruz_Blanca_comuna_empresa, " +
            " m.sa_motivo_desc, r.sa_estado_rechazado_Cruz_Blanca_desc, " +
            " a.sa_archivo_Cruz_Blanca_direccion_dg, a.sa_archivo_Cruz_Blanca_fecha_ingreso, a.sa_archivo_Cruz_Blanca_fecha_carga, " +
            " a.sa_archivo_Cruz_Blanca_fecha_notificacion, a.sa_archivo_Cruz_Blanca_fecha_dg, a.sa_archivo_Cruz_Blanca_fecha_proceso, " +
            " a.sa_archivo_Cruz_Blanca_fecha_rendicion, a.sa_archivo_Cruz_Blanca_fecha_rechazo, a.sa_archivo_Cruz_Blanca_fecha_finiquito " +
            " from sa_archivo_Cruz_Blanca as a " +
            " inner join sa_notificador as n on a.sa_notificador = n.sa_notificador " +
            " inner join sa_estado_rechazado_Cruz_Blanca as r on a.sa_estado_rechazado_Cruz_Blanca = r.sa_estado_rechazado_Cruz_Blanca " +
            " inner join sa_motivo as m on m.sa_motivo = a.sa_motivo " +
            " where a.sa_archivo_Cruz_Blanca_fun = @fun OR a.sa_archivo_Cruz_Blanca = @fun";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.sa_archivo_Cruz_Blanca as [Código Único], a.sa_archivo_Cruz_Blanca_fun as [FUN], a.sa_archivo_Cruz_Blanca_tipo_fun as [Tipo FUN], n.sa_notificador_nombre as [Notificador], " +
            " a.sa_archivo_Cruz_Blanca_rut_afiliado as [Rut Afiliado], a.sa_archivo_Cruz_Blanca_nombre_empresa as [Nombre Empresa], a.sa_archivo_Cruz_Blanca_direccion_empresa as [Dirección Empresa], " +
            " a.sa_archivo_Cruz_Blanca_comuna_empresa as [Comuna Empresa], m.sa_motivo_desc as [Motivo], r.sa_estado_rechazado_Cruz_Blanca_desc as [Detalle Rechazado], " +
            ...
            " inner join sa_estado_rechazado_Cruz_Blanca as r on a.sa_estado_rechazado_Cruz_Blanca = r.sa_estado_rechazado_Cruz_Blanca " +
            " inner join sa_motivo as m on m.sa_motivo = a.sa_motivo " +
            " where a.sa_archivo_Cruz_Blanca_fun like '%" + @fun + "%' OR a.sa_archivo_Cruz_Blanca_rut_afiliado like '%" + @fun + "%' OR a.sa_archivo_Cruz_Blanca_nombre_empresa like '%" + @fun + "%'";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.*, n.sa_notificador_nombre, m.sa_motivo_desc, sr.sa_estado_rechazado_Cruz_Blanca_desc " +
            " from sa_archivo_Cruz_Blanca as a " +
            " inner join sa_notificador as n on a.sa_notificador = n.sa_notificador " +
            " inner join sa_estado_rechazado_Cruz_Blanca as sr on a.sa_estado_rechazado_Cruz_Blanca = sr.sa_estado_rechazado_Cruz_Blanca " +
            ...
            string fechaRendicion, string fechaRechazo, string fechaFiniquito, string fechaDescarga, int notificador, string fun, string Remesa)
        {
            int res = 0;
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_tipo_fun = @tipoFun, sa_archivo_Cruz_Blanca_rut_afiliado = @rut, " +
            " sa_archivo_Cruz_Blanca_nombre_empresa = @nombreE, sa_archivo_Cruz_Blanca_direccion_empresa = @direccionE, sa_archivo_Cruz_Blanca_comuna_empresa = @comunaE, " +
            " sa_motivo = @motivo, sa_estado_rechazado_Cruz_Blanca = @rechazo, sa_archivo_Cruz_Blanca_direccion_dg = @direccionDG, " +
            " sa_archivo_Cruz_Blanca_fecha_ingreso = @fechaIngreso, sa_archivo_Cruz_Blanca_fecha_carga = @fechaCarga, " +
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select sa_archivo_Cruz_Blanca_fun as [FUN] from sa_archivo_Cruz_Blanca " +
            " where sa_notificador = @notificador and sa_archivo_Cruz_Blanca_fecha_carga = @fecha";
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select sa_archivo_Cruz_Blanca_tipo_fun, sa_archivo_Cruz_Blanca_rut_afiliado, sa_archivo_Cruz_Blanca_nombre_empresa, sa_archivo_Cruz_Blanca_direccion_empresa " +
            " from sa_archivo_Cruz_Blanca where sa_archivo_Cruz_Blanca_fun = @fun";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        public int ActualizarNotificador(int codigo, string fecha_carga, string fun)
        {
            int res = 0;
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_notificador = @codigo, sa_archivo_Cruz_Blanca_fecha_carga = @fecha_carga where sa_archivo_Cruz_Blanca_fun= @fun";
            ...
            string fun)
        {
            int res = 0;
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_nombre_empresa = @nombre_empresa, sa_archivo_Cruz_Blanca_comuna_empresa = @comuna_empresa, " +
            " sa_archivo_Cruz_Blanca_direccion_empresa = @direccion_empresa, sa_motivo = @motivo, sa_estado_rechazado_Cruz_Blanca = @estado_rechazado, sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion, " +
            " sa_archivo_Cruz_Blanca_fecha_descarga = @fecha_descarga, sa_archivo_Cruz_Blanca_fecha_rechazo = NULL where sa_archivo_Cruz_Blanca_fun= @fun";
            ...
            string fecha_rechazo, string fecha_descarga, string fun)
        {
            ...
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_nombre_empresa = @nombre_empresa, sa_archivo_Cruz_Blanca_comuna_empresa = @comuna_empresa, " +
            " sa_archivo_Cruz_Blanca_direccion_empresa = @direccion_empresa, sa_motivo = @motivo, sa_estado_rechazado_Cruz_Blanca = @estado_rechazado, sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion, " +
            " sa_archivo_Cruz_Blanca_fecha_rechazo = @fecha_rechazo, sa_archivo_Cruz_Blanca_fecha_descarga = @fecha_descarga where sa_archivo_Cruz_Blanca_fun= @fun";
            update.Parameters.AddWithValue("@nombre_empresa", nombre_empresa);
            update.Parameters.AddWithValue("@comuna_empresa", comuna_empresa);
            update.Parameters.AddWithValue("@direccion_empresa", direccion_empresa);
            update.Parameters.AddWithValue("@motivo", motivo);
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.sa_archivo_Cruz_Blanca_fun as [FUN], a.sa_archivo_Cruz_Blanca_tipo_fun as [Tipo FUN], n.sa_notificador_nombre as [Notificador], " +
            " a.sa_archivo_Cruz_Blanca_rut_afiliado as [Rut Afiliado], a.sa_archivo_Cruz_Blanca_nombre_empresa as [Nombre Empresa], " +
            " a.sa_archivo_Cruz_Blanca_direccion_empresa as [Dirección Empresa], a.sa_archivo_Cruz_Blanca_comuna_empresa as [Comuna Empresa], m.sa_motivo_desc as [Motivo], " +
            " r.sa_estado_rechazado_Cruz_Blanca_desc as [Detalle Rechazado], a.sa_archivo_Cruz_Blanca_direccion_dg as [Dirección D.G.], a.sa_archivo_Cruz_Blanca_fecha_ingreso as [Fecha Ingreso], " +
            " a.sa_archivo_Cruz_Blanca_fecha_carga as [Fecha Carga], a.sa_archivo_Cruz_Blanca_fecha_notificacion as [Fecha Notificación], a.sa_archivo_Cruz_Blanca_fecha_dg as [Fecha D.G.], " +
            " a.sa_archivo_Cruz_Blanca_fecha_proceso as [Fecha Proceso], a.sa_archivo_Cruz_Blanca_fecha_rendicion as [Fecha Rendición], a.sa_archivo_Cruz_Blanca_fecha_rechazo as [Fecha de Rechazo], " +
            ...
            " inner join sa_estado_rechazado_Cruz_Blanca as r on a.sa_estado_rechazado_Cruz_Blanca = r.sa_estado_rechazado_Cruz_Blanca " +
            " inner join sa_motivo as m on m.sa_motivo = a.sa_motivo " +
            " where a.sa_archivo_Cruz_Blanca_fecha_rendicion is null or a.sa_archivo_Cruz_Blanca_fecha_rendicion = ''";
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
            return tabla;
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select a.sa_archivo_Cruz_Blanca_fun, a.sa_archivo_Cruz_Blanca_tipo_fun, a.sa_archivo_Cruz_Blanca_rut_afiliado, a.sa_archivo_Cruz_Blanca_nombre_empresa, " +
            " a.sa_archivo_Cruz_Blanca_direccion_empresa, a.sa_archivo_Cruz_Blanca_comuna_empresa, m.sa_motivo_desc, r.sa_estado_rechazado_Cruz_Blanca_desc, " +
            " a.sa_archivo_Cruz_Blanca_direccion_dg, a.sa_archivo_Cruz_Blanca_fecha_ingreso, a.sa_archivo_Cruz_Blanca_fecha_carga, " +
            " a.sa_archivo_Cruz_Blanca_fecha_notificacion, a.sa_archivo_Cruz_Blanca_fecha_dg, a.sa_archivo_Cruz_Blanca_fecha_proceso, " +
            " a.sa_archivo_Cruz_Blanca_fecha_rendicion, a.sa_archivo_Cruz_Blanca_fecha_rechazo, a.sa_archivo_Cruz_Blanca_fecha_finiquito, sa_archivo_Cruz_Blanca_fecha_descarga " +
            " from sa_archivo_Cruz_Blanca as a " +
            " inner join sa_notificador as n on a.sa_notificador = n.sa_notificador " +
            " inner join sa_estado_rechazado_Cruz_Blanca as r on a.sa_estado_rechazado_Cruz_Blanca = r.sa_estado_rechazado_Cruz_Blanca " +
            " inner join sa_motivo as m on m.sa_motivo = a.sa_motivo " +
        ...
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select sa_archivo_Cruz_Blanca_fun, sa_archivo_Cruz_Blanca_rut_afiliado, sa_archivo_Cruz_Blanca_nombre_empresa, sa_archivo_Cruz_Blanca_direccion_empresa, " +
            " sa_archivo_Cruz_Blanca_comuna_empresa from sa_archivo_Cruz_Blanca where sa_archivo_Cruz_Blanca_fun = @fun";
            sel.Parameters.AddWithValue("@fun", fun);
            SqlDataAdapter adaptador = new SqlDataAdapter(sel);
            DataTable tabla = new DataTable();
            adaptador.Fill(tabla);
        ...
        public int DescargaHabilitados(string fecha_rendicion, string fecha_notificacion, string fecha_descarga, int motivo, int rechazado, int usuario, string orden, string tipo_descarga, string fun)
        {
            int res = 0;
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion, sa_archivo_Cruz_Blanca_fecha_notificacion = @fecha_notificacion, " +
            " sa_archivo_Cruz_Blanca_fecha_descarga = @fecha_descarga, sa_motivo = @motivo, sa_estado_rechazado_Cruz_Blanca = @rechazado, sa_usuario = @usuario, sa_archivo_Cruz_Blanca_orden_rendicion = @orden, " +
            " sa_archivo_Cruz_Blanca_tipo_descarga = @tipo_descarga where sa_archivo_Cruz_Blanca_fun= @fun";
            update.Parameters.AddWithValue("@fecha_rendicion", fecha_rendicion);
        ...
        public DataTable VerParaDescargaFueraPlazo(string fun)
        {
            SqlCommand sel = conectar.Comando();
            sel.CommandText = "select sa_archivo_Cruz_Blanca_fun, sa_archivo_Cruz_Blanca_rut_afiliado, sa_archivo_Cruz_Blanca_nombre_empresa, sa_archivo_Cruz_Blanca_direccion_empresa, " +
            " sa_archivo_Cruz_Blanca_comuna_empresa, sa_archivo_Cruz_Blanca_fecha_rendicion " +
            " from sa_archivo_Cruz_Blanca as a " +
            " inner join sa_notificador as n on a.sa_notificador = n.sa_notificador " +
            " inner join sa_estado_rechazado_Cruz_Blanca as r on a.sa_estado_rechazado_Cruz_Blanca = r.sa_estado_rechazado_Cruz_Blanca " +
            " inner join sa_motivo as m on m.sa_motivo = a.sa_motivo " +
        ...
        public int ActualizarFueraPlazo(string fecha_rendicion, string fecha_notificacion, string fecha_descarga, int motivo, int usuario, string orden, string tipo_descarga, string fun)
        {
            int res = 0;
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion, " +
            " sa_archivo_Cruz_Blanca_fecha_notificacion = @fecha_notificacion, sa_archivo_Cruz_Blanca_fecha_descarga = @fecha_descarga, " +
            " sa_motivo = @motivo, sa_usuario = @usuario, sa_archivo_Cruz_Blanca_orden_rendicion = @orden, sa_archivo_Cruz_Blanca_tipo_descarga = @tipo_descarga where sa_archivo_Cruz_Blanca_fun= @fun";
            update.Parameters.AddWithValue("@fecha_rendicion", fecha_rendicion);
            update.Parameters.AddWithValue("@fecha_notificacion", fecha_notificacion);
            update.Parameters.AddWithValue("@fecha_descarga", fecha_descarga);
            update.Parameters.AddWithValue("@motivo", motivo);
            ...
            int usuario, string orden, string tipo_descarga, string fun)
        {
            ...
            SqlCommand update = conectar.Comando();
            update.CommandText = "update sa_archivo_Cruz_Blanca set sa_archivo_Cruz_Blanca_fecha_rendicion = @fecha_rendicion, sa_archivo_Cruz_Blanca_fecha_notificacion = @fecha_notificacion, " +
            " sa_archivo_Cruz_Blanca_fecha_descarga = @fecha_descarga, sa_archivo_Cruz_Blanca_fecha_finiquito = @fecha_finiquito, sa_archivo_Cruz_Blanca_fecha_rechazo = @fecha_rechazado, " +
            " sa_motivo = @motivo, sa_estado_rechazado_Cruz_Blanca = @rechazado, sa_usuario = @usuario, sa_archivo_Cruz_Blanca_orden_rendicion = @orden, sa_archivo_Cruz_Blanca_tipo_descarga = @tipo_descarga " +
            " where sa_archivo_Cruz_Blanca_fun= @fun";
            update.Parameters.AddWithValue("@fecha_rendicion", fecha_rendicion);
            update.Parameters.AddWithValue("@fecha_notificacion", fecha_notificacion);
            update.Parameters.AddWithValue("@fecha_descarga", fecha_descarga);
