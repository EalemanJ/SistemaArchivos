...
{
    public partial class frmRendicionEsencial : Form
    {
        public frmRendicionEsencial()
        {
            InitializeComponent();
        }
        ...
        private void BtnVerificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoEsencial().BuscarRendicion(txtFun.Text);
                    ...
                    else
                    {
                        foreach (DataRow item in consulta.Rows)
                        {
                            ...
                            txtComunaE.Text = item["sa_archivo_esencial_comuna_empresa"].ToString();
                            txtDireccionE.Text = item["sa_archivo_esencial_direccion_empresa"].ToString();
                            ...
                            txtFechaRendicion.Text = item["sa_archivo_esencial_fecha_rendicion"].ToString();
                            txtNombreE.Text = item["sa_archivo_esencial_nombre_empresa"].ToString();
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int actualizar = new ArchivoEsencial().ActualizarFechaRendicion(txtFechaRendicion.Text.Replace("/", "-"), txtFun.Text);
