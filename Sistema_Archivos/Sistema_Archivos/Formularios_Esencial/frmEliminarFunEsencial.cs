...
{
    public partial class frmEliminarFunEsencial : Form
    {
        public frmEliminarFunEsencial()
        {
            InitializeComponent();
        }
        ...
        private void BtnVerificar_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable consulta = new ArchivoEsencial().VerFunEliminar(txtFun.Text);
                ...
                else
                {
                    ...
                    {
                        dgvEliminarFun.Rows.Add(item["sa_archivo_esencial"].ToString(), item["sa_archivo_esencial_fun"].ToString(), item["sa_archivo_esencial_tipo_fun"].ToString(),
                            item["sa_notificador_nombre"].ToString(), item["sa_archivo_esencial_rut_afiliado"].ToString(), item["sa_archivo_esencial_nombre_empresa"].ToString(),
                            ...
                            item["sa_archivo_esencial_fecha_finiquito"].ToString());
                    }
                    txtFun.Text = "";
                    txtFun.Focus();
                }
            ...
            try
            {
                ...
                else
                {
                    foreach (DataGridViewRow row in dgvEliminarFun.Rows)
                    {
                        ...
                        int eliminar_fun = new ArchivoEsencial().EliminarFun(codigo_fun);
                    }
        ...
        private void frmEliminarFunesencial_Load(object sender, EventArgs e)
        {
            try
            {
                txtFun.Focus();
