            ...
            try
            {
                ...
                else
                {
                    ...
                    if (cmbMotivo.Text != "Rechazado")
                    {
                        ...
                        int eliminar = new ArchivoEsencial().EliminarRechazado(txtRutAfiliado.Text);
                    }
                    else
                    {
                        actualizar_todo = new ArchivoEsencial().ActualizarTodo(tipo_fun, txtRutAfiliado.Text, txtNombreEmpresa.Text, txtDireccionEmpresa.Text,
                        ...
                        if (rechazo == 6)
                        {
                            ...
                            {
                                int inserta = new ArchivoEsencial().IngresaInubicable(txtRutAfiliado.Text);
                            }
                        }
                    }
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Sesion.VerificarInubicableEsencial(item["sa_archivo_esencial_rut_afiliado"].ToString()))
                            {
