...
{
    public partial class frmMantenedorPrincipalEsencial : Form
    {
        ...
        public frmMantenedorPrincipalEsencial()
        {
            InitializeComponent();
        }

        private void frmMantenedorPrincipalEsencial_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbDescargarRechazados.DataSource = new EstadoRechazadoEsencialDAL().VerEstadosRechazado();
                cmbDescargarRechazados.DisplayMember = "sa_estado_rechazado_esencial_desc";
                cmbDescargarRechazados.ValueMember = "sa_estado_rechazado_esencial";
            }
            catch (Exception ex)
            {
        ...
        private void TcPanelPrincipal_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtFUN.Focus();
                frmMantenedorPrincipalEsencial mp = System.Windows.Forms.Application.OpenForms["frmMantenedorPrincipalEsencial"] as frmMantenedorPrincipalEsencial;
        ...
        private void BtnBuscarFUN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Data.DataTable consulta = new ArchivoEsencial().BuscarPorFUN(txtFUN.Text);
        ...
        private void BtnAsignar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int actualizar = new ArchivoEsencial().ActualizarNotificador(codigo_notificador, fecha_carga, txtFUN.Text);
        ...
        private void BtnBuscarDescargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Data.DataTable consulta = new ArchivoEsencial().BuscarFUNNotificador(txtFunDescargar.Text);
                    if (consulta.Rows.Count == 0)
                    {
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            txtFunDescargar.Text = item["sa_archivo_esencial_fun"].ToString();
                            txtFunDescargar.ReadOnly = true;
                            txtTipoFunDescargar.Text = item["sa_archivo_esencial_tipo_fun"].ToString();
                            txtNombreEmpresaDescargar.Text = item["sa_archivo_esencial_nombre_empresa"].ToString();
                            txtComunaDescargar.Text = item["sa_archivo_esencial_comuna_empresa"].ToString();
                            txtNotificadorDescargar.Text = item["sa_notificador_nombre"].ToString();
                            txtDireccionDGDescargar.Text = item["sa_archivo_esencial_direccion_dg"].ToString();
                            txtFechaIngresoDescargar.Text = item["sa_archivo_esencial_fecha_ingreso"].ToString();
                            txtFechaCargaDescargar.Text = item["sa_archivo_esencial_fecha_carga"].ToString();
                            txtFechaNotificacionDescargar.Text = item["sa_archivo_esencial_fecha_notificacion"].ToString();
                            txtFechaDGDescargar.Text = item["sa_archivo_esencial_fecha_dg"].ToString();
                            txtRutAfiliadoDescargar.Text = item["sa_archivo_esencial_rut_afiliado"].ToString();
                            txtDireccionEmpresaDescargar.Text = item["sa_archivo_esencial_direccion_empresa"].ToString();
                            txtFechaProcesoDescargar.Text = item["sa_archivo_esencial_fecha_proceso"].ToString();
                            txtFechaRechazoDescargar.Text = item["sa_archivo_esencial_fecha_rechazo"].ToString();
                            txtFechaFiniquitoDescargar.Text = item["sa_archivo_esencial_fecha_finiquito"].ToString();
                            ...
                            estado_carga = true;
                            //cargar motivos
                            cmbMotivoDescargar.DataSource = new MotivoDAL().CargarListaSeleccionadoEsencial(txtFunDescargar.Text);
                            cmbMotivoDescargar.DisplayMember = "sa_motivo_desc";
                            cmbMotivoDescargar.ValueMember = "sa_motivo";
                            //cargar estados de error
                            cmbObervacionDescargar.DataSource = new EstadoRechazadoEsencialDAL().CargarListaSeleccionadoRechazado(txtFunDescargar.Text);
                            cmbObervacionDescargar.DisplayMember = "sa_estado_rechazado_esencial_desc";
                            cmbObervacionDescargar.ValueMember = "sa_estado_rechazado_esencial";
                        }
                    }
                }
            }
        ...
        private void BtnDescargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbMotivoDescargar.Text == "Habilitado")
                {
                    ...
                    int actualizar = new ArchivoEsencial().ActualizarConHabilitado(txtNombreEmpresaDescargar.Text, txtComunaDescargar.Text, txtDireccionEmpresaDescargar.Text,
                ...
                else if (cmbMotivoDescargar.Text == "Rechazado")
                {
                    ...
                    int actualizar = new ArchivoEsencial().ActualizarSinHabilitado(txtNombreEmpresaDescargar.Text, txtComunaDescargar.Text, txtDireccionEmpresaDescargar.Text,
        ...
        private void BtnVerFunesPendientes_Click(object sender, EventArgs e)
        {
            try
            {
                System.Data.DataTable consulta_funes = new ArchivoEsencial().VerFunesPendientes();
        ...
        private void BtnGenerarReporteFuenasPendientes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ExportarExcel(dgvFunesPendientes, "funesPendientesEsencial.xlsx");
        ...
        private void BtnAgregarCargaAutomatica_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        System.Data.DataTable consulta = new ArchivoEsencial().VerParaCargaAutomatica(txtFunCargaAutomatica.Text);
                        if (consulta.Rows.Count == 0)
                        {
                        ...
                        else
                        {
                            ...
                            foreach (System.Data.DataRow item in consulta.Rows)
                            {
                                ...
                                rut_afiliado = item["sa_archivo_esencial_rut_afiliado"].ToString();
                                System.Data.DataTable anterior = new ArchivoEsencial().VerAnterior(rut_afiliado, txtFunCargaAutomatica.Text);
                                foreach (System.Data.DataRow dr in anterior.Rows)
                                {
                                    direccion_dg = dr["sa_archivo_esencial_direccion_dg"].ToString();
                                }
                                ...
                                System.Data.DataTable inubicable = new ArchivoEsencial().VerInubicable(rut_afiliado);
                                ...
                                {
                                    dgvCargaAutomatica.Rows.Add(txtFunCargaAutomatica.Text, item["sa_archivo_esencial_tipo_fun"].ToString(), cmbNotificadorCargaAutomatica.Text,
                                    item["sa_archivo_esencial_rut_afiliado"].ToString(), item["sa_archivo_esencial_nombre_empresa"].ToString(),
                                    item["sa_archivo_esencial_direccion_empresa"].ToString(), item["sa_archivo_esencial_comuna_empresa"].ToString(), item["sa_motivo_desc"].ToString(),
                                    item["sa_estado_rechazado_esencial_desc"].ToString(), item["sa_archivo_esencial_direccion_dg"].ToString(), item["sa_archivo_esencial_fecha_ingreso"].ToString(),
                                    item["sa_archivo_esencial_fecha_carga"].ToString(), item["sa_archivo_esencial_fecha_notificacion"].ToString(), item["sa_archivo_esencial_fecha_dg"].ToString(),
                                    item["sa_archivo_esencial_fecha_proceso"].ToString(), item["sa_archivo_esencial_fecha_rendicion"].ToString(), item["sa_archivo_esencial_fecha_rechazo"].ToString(),
                                    item["sa_archivo_esencial_fecha_finiquito"].ToString(), item["sa_archivo_esencial_fecha_descarga"].ToString());
                                    txtFunCargaAutomatica.Text = "";
                                    txtFunCargaAutomatica.Focus();
                                }
                            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow row in dgvCargaAutomatica.Rows)
                    {
                        ...
                        actualizar = new ArchivoEsencial().ActualizarNotificador(codigo_notificador, fecha_carga, fun);
                    }
                    if (actualizar >= 1)
                    {
        ...
        private void BtnBuscarDescargaAutomatica_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    System.Data.DataTable consulta = new ArchivoEsencial().BuscarDatosFun(txtFunDescargaAutomatica.Text);
                    if (consulta.Rows.Count == 0)
                    {
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            ...
                            dgvDescargaAutomatica.Rows.Add(txtFunDescargaAutomatica.Text, item["sa_archivo_esencial_nombre_empresa"].ToString(), item["sa_archivo_esencial_direccion_empresa"].ToString(),
                                item["sa_archivo_esencial_comuna_empresa"].ToString(), item["sa_archivo_esencial_rut_afiliado"].ToString(), "Habilitado",
                ...
                else
                {
                    ...
                    if (estado_fecha == true)
                    {
                        foreach (DataGridViewRow row in dgvDescargaAutomatica.Rows)
                        {
                            ...
                            actualizar = new ArchivoEsencial().DescargaHabilitados(fecha_rendicion, fecha_notificacion, fecha_descarga, habilitado, estado_rechazado, Sesion.IdUsuario, orden, "HAB", fun);
                        }
                        if (actualizar >= 1)
                        {
                            ExportarExcel(dgvDescargaAutomatica, "DescargaHabilitadosEsencial.xlsx");
        ...
        private void BtnVerificarDescargarFueraPlazo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string fecha_rendicion = DateTime.Now.Date.ToShortDateString().Replace("/", "-");
                    System.Data.DataTable consulta = new ArchivoEsencial().VerParaDescargaFueraPlazo(txtFunDescargarFueraPlazo.Text);
                    if (consulta.Rows.Count == 0)
                    {
                        MessageBox.Show("No se han encontrado registros del FUN ingresado.", "SIN DATOS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        txtFunDescargarFueraPlazo.Text = "";
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            ...
                            dgvDescargarFueraPlazo.Rows.Add(txtFunDescargarFueraPlazo.Text, item["sa_archivo_esencial_nombre_empresa"].ToString(),
                                item["sa_archivo_esencial_direccion_empresa"].ToString(), item["sa_archivo_esencial_comuna_empresa"].ToString(),
                                item["sa_archivo_esencial_rut_afiliado"].ToString(), "Habilitado F.P.",
                                fecha_rendicion, "");
                ...
                else
                {
                    ...
                    if (estado_fecha == true)
                    {
                        ...
                        foreach (DataGridViewRow row in dgvDescargarFueraPlazo.Rows)
                        {
                            ...
                            fecha_notificacion = fecha_notificacion.Replace("/", "-");
                            System.Threading.Thread.Sleep(10);
                            actualizar = new ArchivoEsencial().ActualizarFueraPlazo(fecha_rendicion, fecha_notificacion, fecha_descarga, motivo, Sesion.IdUsuario, orden, "FPL", fun);
                        }
                        ExportarExcel(dgvDescargarFueraPlazo, "descargarFueraPlazoEsencial.xlsx");
        ...
        private void BtnVerificarDescargarRechazados_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string fecha_rendicion = DateTime.Now.Date.ToShortDateString().Replace("/", "-");
                    System.Data.DataTable consulta = new ArchivoEsencial().BuscarDatosFun(txtFunDescargarRechazados.Text);
                    foreach (System.Data.DataRow item in consulta.Rows)
                    {
                        ...
                        dgvDescargarRechazados.Rows.Add(txtFunDescargarRechazados.Text, item["sa_archivo_esencial_nombre_empresa"].ToString(), item["sa_archivo_esencial_direccion_empresa"].ToString(),
                                item["sa_archivo_esencial_comuna_empresa"].ToString(), item["sa_archivo_esencial_rut_afiliado"].ToString(), cmbDescargarRechazados.Text,
                        ...
                        foreach (DataGridViewRow row in dgvDescargarRechazados.Rows)
                        {
                            ...
                            if (codigo_rechazo == 7)
                            {
                                if (!Sesion.VerificarInubicableEsencial(rut))
                                {
                                    ...
                                    int ingresa = new ArchivoEsencial().IngresaInubicable(rut);
                                }
                            }
                        }
                        if (actualizar >= 1)
                        {
                            ExportarExcel(dgvDescargarRechazados, "DescargaRechazadosEsencial.xlsx");
                            MessageBox.Show("Actualización correcta.", "DATOS ACTUALIZADOS", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                            txtFunDescargarRechazados.Text = "";
                            txtFunDescargarRechazados.Focus();
                            dgvDescargarRechazados.Rows.Clear();
