...
{
    public partial class frmGenerarCargaNotificadorEsencial : Form
    {
        public frmGenerarCargaNotificadorEsencial()
        {
            InitializeComponent();
        }

        private void frmGenerarCargaNotificadoresencial_Load(object sender, EventArgs e)
        {
            try
            {
                Info_dgv();
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Data.DataTable consulta = new ArchivoEsencial().GenerarArchivoCarga(notificador, fecha);
