...
{
    public partial class frmEliminarFunCruzBlanca : Form
    {
        public frmEliminarFunCruzBlanca()
        {
            InitializeComponent();
        }
        ...
        private void BtnVerificar_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable consulta = new ArchivoCruzBlanca().VerFunEliminar(txtFun.Text);
                ...
                else
                {
                    ...
                    {
                        dgvEliminarFun.Rows.Add(item["sa_archivo_Cruz_Blanca"].ToString(), item["sa_archivo_Cruz_Blanca_fun"].ToString(), item["sa_archivo_Cruz_Blanca_tipo_fun"].ToString(),
                            item["sa_notificador_nombre"].ToString(), item["sa_archivo_Cruz_Blanca_rut_afiliado"].ToString(), item["sa_archivo_Cruz_Blanca_nombre_empresa"].ToString(),
                            ...
                            item["sa_archivo_Cruz_Blanca_fecha_finiquito"].ToString());
                    }
                    txtFun.Text = "";
                    txtFun.Focus();
                }
            ...
            try
            {
                ...
                else
                {
                    foreach (DataGridViewRow row in dgvEliminarFun.Rows)
                    {
                        ...
                        int eliminar_fun = new ArchivoCruzBlanca().EliminarFun(codigo_fun);
                    }
        ...
        private void frmEliminarFunCruzBlanca_Load(object sender, EventArgs e)
        {
            try
            {
                txtFun.Focus();
