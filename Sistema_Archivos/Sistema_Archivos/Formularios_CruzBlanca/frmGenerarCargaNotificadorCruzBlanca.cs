...
{
    public partial class frmGenerarCargaNotificadorCruzBlanca : Form
    {
        public frmGenerarCargaNotificadorCruzBlanca()
        {
            InitializeComponent();
        }

        private void frmGenerarCargaNotificadorCruzBlanca_Load(object sender, EventArgs e)
        {
            try
            {
                Info_dgv();
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Data.DataTable consulta = new ArchivoCruzBlanca().GenerarArchivoCarga(notificador, fecha);
