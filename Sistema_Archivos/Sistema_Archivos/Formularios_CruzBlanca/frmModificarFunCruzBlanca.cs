...
{
    public partial class frmModificarFunCruzBlanca : Form
    {
        public frmModificarFunCruzBlanca()
        {
            InitializeComponent();
        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (rechazo == 6)
                        {
                            ...
                            {
                                int inserta = new ArchivoCruzBlanca().IngresaInubicable(txtRutAfiliado.Text);
                            }
                        }
                    }
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoCruzBlanca().BuscarFUNNotificador(txtFun.Text);
                    ...
                    else
                    {
                        ...
                        {
                            if (Sesion.VerificarInubicableCruzBlanca(item["sa_archivo_Cruz_Blanca_rut_afiliado"].ToString()))
                            {
                            ...
                            txtComuna.Text = item["sa_archivo_Cruz_Blanca_comuna_empresa"].ToString();
                            txtDireccionDG.Text = item["sa_archivo_Cruz_Blanca_direccion_dg"].ToString();
                            ...
                            txtFechaDG.Text = item["sa_archivo_Cruz_Blanca_fecha_dg"].ToString();
                            txtFechaFiniquito.Text = item["sa_archivo_Cruz_Blanca_fecha_finiquito"].ToString();
                            txtFechaIngreso.Text = item["sa_archivo_Cruz_Blanca_fecha_ingreso"].ToString();
                            txtFechaNotificacion.Text = item["sa_archivo_Cruz_Blanca_fecha_notificacion"].ToString();
                            txtFechaProceso.Text = item["sa_archivo_Cruz_Blanca_fecha_proceso"].ToString();
                            txtFechaRechazo.Text = item["sa_archivo_Cruz_Blanca_fecha_rechazo"].ToString();
                            ...
                            cmbObervacion.ValueMember = "sa_estado_rechazado_Cruz_Blanca";
                            cmbObervacion.DisplayMember = "sa_estado_rechazado_Cruz_Blanca_desc";
                            //cargar notificadores
                            cmbNuevoNotificador.DataSource = new NotificadorDAL().NotificadorCruzBlanca(txtFun.Text);
                            cmbNuevoNotificador.ValueMember = "sa_notificador";
                            cmbNuevoNotificador.DisplayMember = "sa_notificador_nombre";
                            //motivos
                            cmbMotivo.DataSource = new MotivoDAL().CargarListaSeleccionadoCruzBlanca(txtFun.Text);
        ...
        private void frmModificarFunCruzBlanca_Load(object sender, EventArgs e)
        {
            txtFun.Focus();
        }
