...
{
    public partial class frmIngresoCruzBlanca : Form
    {
        public frmIngresoCruzBlanca()
        {
            InitializeComponent();
        }
        ...
        private void BtnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Validar_campos())
                {
                    ...
                    {
                        //rechazado
                        int ingreso = new ArchivoCruzBlanca().Ingreso(txtFun.Text, txtTipoFun.Text, txtRutAfiliado.Text, txtNombreEmpresa.Text, txtDireccionEmpresa.Text, txtComunaEmpresa.Text,
        ...
        private void frmIngresoCruzBlanca_Load(object sender, EventArgs e)
        {
            Cargar_lista();
            Limpiar_y_cargar();
            txtFun.Focus();
        ...
        public void Cargar_lista()
        {
            try
            {
                ...
                cmbObservacion.DataSource = new EstadoRechazadoCruzBlancaDAL().VerEstadosRechazado();
                cmbObservacion.DisplayMember = "sa_estado_rechazado_Cruz_Blanca_desc";
                cmbObservacion.ValueMember = "sa_estado_rechazado_Cruz_Blanca";
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoCruzBlanca().BuscarFUN(txtFun.Text);
