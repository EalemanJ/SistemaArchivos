...
{
    public partial class frmIngresoColmena : Form
    {
        public frmIngresoColmena()
        {
            InitializeComponent();
        }
        ...
        private void BtnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Validar_campos() == true)
                {
                    ...
                    {
                        //rechazado
                        int ingreso = new ArchivoColmenaDAL().Ingreso(txtFun.Text, txtTipoFun.Text, txtRutAfiliado.Text, txtNombreEmpresa.Text, txtDireccionEmpresa.Text, txtComunaEmpresa.Text,
                            motivo, estado_rechazo, txtDireccionDG.Text, txtFechaIngreso.Text, txtFechaCarga.Text, txtFechaNoti.Text, txtFechaDG.Text, txtFechaProceso.Text, txtFechaRendicion.Text,
                            txtfechaRechazo.Text, txtFechaFiniquito.Text, fecha_descarga, notificador, Sesion.IdUsuario);
        ...
        private void frmIngresoColmena_Load(object sender, EventArgs e)
        {
            Cargar_lista();
            Limpiar_y_cargar();
            txtFun.Focus();
        ...
        public void Cargar_lista()
        {
            try
            {
                ...
                cmbObservacion.DataSource = new EstadoRechazadoColmenaDAL().VerEstadosRechazado();
                cmbObservacion.DisplayMember = "sa_estado_rechazado_colmena_desc";
                cmbObservacion.ValueMember = "sa_estado_rechazado_colmena";
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoColmenaDAL().BuscarFUN(txtFun.Text);
