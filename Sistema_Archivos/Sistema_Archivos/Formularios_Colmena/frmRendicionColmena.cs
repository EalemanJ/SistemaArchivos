...
{
    public partial class frmRendicionColmena : Form
    {
        public frmRendicionColmena()
        {
            InitializeComponent();
        }
        ...
        private void BtnVerificar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable consulta = new ArchivoColmenaDAL().BuscarRendicion(txtFun.Text);
                    ...
                    else
                    {
                        foreach (DataRow item in consulta.Rows)
                        {
                            ...
                            txtComunaE.Text = item["sa_archivo_colmena_comuna_empresa"].ToString();
                            txtDireccionE.Text = item["sa_archivo_colmena_direccion_empresa"].ToString();
                            ...
                            txtFechaRendicion.Text = item["sa_archivo_colmena_fecha_rendicion"].ToString();
                            txtNombreE.Text = item["sa_archivo_colmena_nombre_empresa"].ToString();
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int actualizar = new ArchivoColmenaDAL().ActualizarFechaRendicion(txtFechaRendicion.Text, txtFun.Text);
