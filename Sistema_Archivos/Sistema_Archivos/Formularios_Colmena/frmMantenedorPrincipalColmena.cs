...
{
    public partial class frmMantenedorPrincipalColmena : Form
    {
        ...
        public frmMantenedorPrincipalColmena()
        {
            InitializeComponent();
        }

        private void frmMantenedorPrincipalColmena_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                cmbDescargarRechazados.DataSource = new EstadoRechazadoColmenaDAL().VerEstadosRechazado();
                cmbDescargarRechazados.DisplayMember = "sa_estado_rechazado_colmena_desc";
                cmbDescargarRechazados.ValueMember = "sa_estado_rechazado_colmena";
            }
            catch (Exception ex)
            {
        ...
        private void TcPanelPrincipal_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                txtFUN.Focus();
                frmMantenedorPrincipalColmena mp = System.Windows.Forms.Application.OpenForms["frmMantenedorPrincipalColmena"] as frmMantenedorPrincipalColmena;
        ...
        private void BtnBuscarFUN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Data.DataTable consulta = new ArchivoColmenaDAL().BuscarPorFUN(txtFUN.Text);
        ...
        private void BtnAsignar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int actualizar = new ArchivoColmenaDAL().ActualizarNotificador(codigo_notificador, fecha_carga, txtFUN.Text);
        ...
        private void BtnBuscarDescargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Data.DataTable consulta = new ArchivoColmenaDAL().BuscarFUNNotificador(txtFunDescargar.Text);
                    if (consulta.Rows.Count == 0)
                    {
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            txtFunDescargar.Text = item["sa_archivo_colmena_fun"].ToString();
                            txtFunDescargar.ReadOnly = true;
                            txtTipoFunDescargar.Text = item["sa_archivo_colmena_tipo_fun"].ToString();
                            txtNombreEmpresaDescargar.Text = item["sa_archivo_colmena_nombre_empresa"].ToString();
                            txtComunaDescargar.Text = item["sa_archivo_colmena_comuna_empresa"].ToString();
                            txtNotificadorDescargar.Text = item["sa_notificador_nombre"].ToString();
                            txtDireccionDGDescargar.Text = item["sa_archivo_colmena_direccion_dg"].ToString();
                            txtFechaIngresoDescargar.Text = item["sa_archivo_colmena_fecha_ingreso"].ToString();
                            txtFechaCargaDescargar.Text = item["sa_archivo_colmena_fecha_carga"].ToString();
                            txtFechaNotificacionDescargar.Text = item["sa_archivo_colmena_fecha_notificacion"].ToString();
                            txtFechaDGDescargar.Text = item["sa_archivo_colmena_fecha_dg"].ToString();
                            txtRutAfiliadoDescargar.Text = item["sa_archivo_colmena_rut_afiliado"].ToString();
                            txtDireccionEmpresaDescargar.Text = item["sa_archivo_colmena_direccion_empresa"].ToString();
                            txtFechaProcesoDescargar.Text = item["sa_archivo_colmena_fecha_proceso"].ToString();
                            txtFechaRechazoDescargar.Text = item["sa_archivo_colmena_fecha_rechazo"].ToString();
                            txtFechaFiniquitoDescargar.Text = item["sa_archivo_colmena_fecha_finiquito"].ToString();
                            ...
                            estado_carga = true;
                            //cargar motivos
                            cmbMotivoDescargar.DataSource = new MotivoDAL().CargarListaSeleccionadoColmena(txtFunDescargar.Text);
                            cmbMotivoDescargar.DisplayMember = "sa_motivo_desc";
                            cmbMotivoDescargar.ValueMember = "sa_motivo";
                            //cargar estados de error
                            cmbObervacionDescargar.DataSource = new EstadoRechazadoColmenaDAL().CargarListaSeleccionadoRechazado(txtFunDescargar.Text);
                            cmbObervacionDescargar.DisplayMember = "sa_estado_rechazado_colmena_desc";
                            cmbObervacionDescargar.ValueMember = "sa_estado_rechazado_colmena";
                        }
                    }
                }
            }
        ...
        private void BtnDescargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbMotivoDescargar.Text == "Habilitado")
                {
                    ...
                    int actualizar = new ArchivoColmenaDAL().ActualizarConHabilitado(txtNombreEmpresaDescargar.Text, txtComunaDescargar.Text, txtDireccionEmpresaDescargar.Text,
                        motivo, estado_rechazo_defecto, txtFechaRendicionDescargar.Text, fecha_descarga, txtFunDescargar.Text);
                    if (actualizar >= 1)
                    {
                ...
                else if (cmbMotivoDescargar.Text == "Rechazado")
                {
                    ...
                    int actualizar = new ArchivoColmenaDAL().ActualizarSinHabilitado(txtNombreEmpresaDescargar.Text, txtComunaDescargar.Text, txtDireccionEmpresaDescargar.Text,
                        motivo, estado_rechazo, txtFechaRendicionDescargar.Text, txtFechaRechazoDescargar.Text, fecha_descarga, txtFunDescargar.Text);
                    if (actualizar >= 1)
                    {
                        MessageBox.Show("Datos guardados correctamente.", "ACTUALIZACIÓN CORRECTA", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        Limpiar_todo();
        ...
        private void BtnVerFunesPendientes_Click(object sender, EventArgs e)
        {
            try
            {
                System.Data.DataTable consulta_funes = new ArchivoColmenaDAL().VerFunesPendientes();
        ...
        private void BtnGenerarReporteFuenasPendientes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ExportarExcel(dgvFunesPendientes, "funesPendientesColmena.xlsx");
        ...
        private void BtnAgregarCargaAutomatica_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        System.Data.DataTable consulta = new ArchivoColmenaDAL().VerParaCargaAutomatica(txtFunCargaAutomatica.Text);
                        if (consulta.Rows.Count == 0)
                        {
                        ...
                        else
                        {
                            foreach (System.Data.DataRow item in consulta.Rows)
                            {
                                dgvCargaAutomatica.Rows.Add(txtFunCargaAutomatica.Text, item["sa_archivo_colmena_tipo_fun"].ToString(), cmbNotificadorCargaAutomatica.Text,
                                    item["sa_archivo_colmena_rut_afiliado"].ToString(), item["sa_archivo_colmena_nombre_empresa"].ToString(),
                                    item["sa_archivo_colmena_direccion_empresa"].ToString(), item["sa_archivo_colmena_comuna_empresa"].ToString(), item["sa_motivo_desc"].ToString(),
                                    item["sa_estado_rechazado_colmena_desc"].ToString(), item["sa_archivo_colmena_direccion_dg"].ToString(), item["sa_archivo_colmena_fecha_ingreso"].ToString(),
                                    item["sa_archivo_colmena_fecha_carga"].ToString(), item["sa_archivo_colmena_fecha_notificacion"].ToString(), item["sa_archivo_colmena_fecha_dg"].ToString(),
                                    item["sa_archivo_colmena_fecha_proceso"].ToString(), item["sa_archivo_colmena_fecha_rendicion"].ToString(), item["sa_archivo_colmena_fecha_rechazo"].ToString(),
                                    item["sa_archivo_colmena_fecha_finiquito"].ToString(), item["sa_archivo_colmena_fecha_descarga"].ToString());
                                txtFunCargaAutomatica.Text = "";
                                txtFunCargaAutomatica.Focus();
                            }
                        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (DataGridViewRow row in dgvCargaAutomatica.Rows)
                    {
                        ...
                        actualizar = new ArchivoColmenaDAL().ActualizarNotificador(codigo_notificador, fecha_carga, fun);
                    }
                    if (actualizar >= 1)
                    {
        ...
        private void BtnBuscarDescargaAutomatica_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    System.Data.DataTable consulta = new ArchivoColmenaDAL().BuscarDatosFun(txtFunDescargaAutomatica.Text);
                    if (consulta.Rows.Count == 0)
                    {
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            ...
                            dgvDescargaAutomatica.Rows.Add(txtFunDescargaAutomatica.Text, item["sa_archivo_colmena_nombre_empresa"].ToString(), item["sa_archivo_colmena_direccion_empresa"].ToString(),
                                item["sa_archivo_colmena_comuna_empresa"].ToString(), item["sa_archivo_colmena_rut_afiliado"].ToString(), "Habilitado",
                ...
                else
                {
                    ...
                    if (estado_fecha == true)
                    {
                        foreach (DataGridViewRow row in dgvDescargaAutomatica.Rows)
                        {
                            ...
                            actualizar = new ArchivoColmenaDAL().DescargaHabilitados(fecha_rendicion, fecha_notificacion, fecha_descarga, habilitado, estado_rechazado, Sesion.IdUsuario, orden, "HAB", fun);
                        }
                        if (actualizar >= 1)
                        {
                            ExportarExcel(dgvDescargaAutomatica, "DescargaHabilitadosColmena.xlsx");
        ...
        private void BtnVerificarDescargarFueraPlazo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string fecha_rendicion = DateTime.Now.Date.ToShortDateString().Replace("/", "-");
                    System.Data.DataTable consulta = new ArchivoColmenaDAL().VerParaDescargaFueraPlazo(txtFunDescargarFueraPlazo.Text);
                    if (consulta.Rows.Count == 0)
                    {
                        MessageBox.Show("No se han encontrado registros del FUN ingresado.", "SIN DATOS", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        txtFunDescargarFueraPlazo.Text = "";
                    ...
                    else
                    {
                        foreach (System.Data.DataRow item in consulta.Rows)
                        {
                            ...
                            dgvDescargarFueraPlazo.Rows.Add(txtFunDescargarFueraPlazo.Text, item["sa_archivo_colmena_nombre_empresa"].ToString(),
                                item["sa_archivo_colmena_direccion_empresa"].ToString(), item["sa_archivo_colmena_comuna_empresa"].ToString(),
                                item["sa_archivo_colmena_rut_afiliado"].ToString(), "Habilitado F.P.",
                                fecha_rendicion, "");
                ...
                else
                {
                    ...
                    if (estado_fecha == true)
                    {
                        ...
                        foreach (DataGridViewRow row in dgvDescargarFueraPlazo.Rows)
                        {
                            ...
                            orden = DateTime.Now.TimeOfDay.ToString();
                            System.Threading.Thread.Sleep(10);
                            actualizar = new ArchivoColmenaDAL().ActualizarFueraPlazo(fecha_rendicion, fecha_notificacion, fecha_descarga, motivo, Sesion.IdUsuario, orden, "FPL", fun);
                        }
        ...
        private void BtnVerificarDescargarRechazados_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string fecha_rendicion = DateTime.Now.Date.ToShortDateString().Replace("/", "-");
                    System.Data.DataTable consulta = new ArchivoColmenaDAL().BuscarDatosFun(txtFunDescargarRechazados.Text);
                    foreach (System.Data.DataRow item in consulta.Rows)
                    {
                        ...
                        dgvDescargarRechazados.Rows.Add(txtFunDescargarRechazados.Text, item["sa_archivo_colmena_nombre_empresa"].ToString(), item["sa_archivo_colmena_direccion_empresa"].ToString(),
                                item["sa_archivo_colmena_comuna_empresa"].ToString(), item["sa_archivo_colmena_rut_afiliado"].ToString(), cmbDescargarRechazados.Text,
                ...
                else
                {
                    ...
                    if (estado_fecha == true)
                    {
                        ...
                        foreach (DataGridViewRow row in dgvDescargarRechazados.Rows)
                        {
                            ...
                            orden = DateTime.Now.TimeOfDay.ToString();
                            System.Threading.Thread.Sleep(10);
                            actualizar = new ArchivoColmenaDAL().DescargarRechazado(fecha_rendicion, fecha_notificacion, fecha_descarga, fecha_finiquito, fecha_rechazo, rechazado, codigo_rechazo, Sesion.IdUsuario, orden, "REC", fun);
                        }
                        if (actualizar >= 1)
                        {
                            ExportarExcel(dgvDescargarRechazados, "DescargaRechazadosColmena.xlsx");
                            MessageBox.Show("Actualización correcta.", "DATOS ACTUALIZADOS", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                            txtFunDescargarRechazados.Text = "";
                            txtFunDescargarRechazados.Focus();
                            dgvDescargarRechazados.Rows.Clear();
