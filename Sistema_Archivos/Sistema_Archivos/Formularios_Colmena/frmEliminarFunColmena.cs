...
{
    public partial class frmEliminarFunColmena : Form
    {
        public frmEliminarFunColmena()
        {
            InitializeComponent();
        }
        ...
        private void BtnVerificar_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable consulta = new ArchivoColmenaDAL().VerFunEliminar(txtFun.Text);
                ...
                else
                {
                    ...
                    {
                        dgvEliminarFun.Rows.Add(item["sa_archivo_colmena"].ToString(), item["sa_archivo_colmena_fun"].ToString(), item["sa_archivo_colmena_tipo_fun"].ToString(),
                            item["sa_notificador_nombre"].ToString(), item["sa_archivo_colmena_rut_afiliado"].ToString(), item["sa_archivo_colmena_nombre_empresa"].ToString(),
                            ...
                            item["sa_archivo_colmena_fecha_finiquito"].ToString());
                    }
                    txtFun.Text = "";
                    txtFun.Focus();
                }
            ...
            try
            {
                ...
                else
                {
                    foreach (DataGridViewRow row in dgvEliminarFun.Rows)
                    {
                        ...
                        int eliminar_fun = new ArchivoColmenaDAL().EliminarFun(codigo_fun);
                    }
        ...
        private void frmEliminarFunColmena_Load(object sender, EventArgs e)
        {
            try
            {
                txtFun.Focus();
