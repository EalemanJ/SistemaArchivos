...
{
    public partial class frmGenerarCargaNotificadorColmena : Form
    {
        public frmGenerarCargaNotificadorColmena()
        {
            InitializeComponent();
        }

        private void frmGenerarCargaNotificadorColmena_Load(object sender, EventArgs e)
        {
            try
            {
                Info_dgv();
        ...
        private void BtnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Data.DataTable consulta = new ArchivoColmenaDAL().GenerarArchivoCarga(notificador, fecha);
